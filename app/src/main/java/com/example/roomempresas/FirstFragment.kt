...
class FirstFragment : Fragment() {
    ...
    private fun insertEmpresaToDB() {
        ...
        if (inputValidation(nombre, direccion, email, telefono, urlFoto)) {
            ...
            Snackbar.make(binding.root, "Empresa ${nombre} añadida!", Snackbar.LENGTH_LONG).show()
        } else {
            Snackbar.make(binding.root, "Asegurate de llenar todos los campos", Snackbar.LENGTH_LONG).show()
        }
